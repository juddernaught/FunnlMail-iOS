//
//  SentEmailThreadTableViewController.m
//  FunnlMail
//
//  Created by Pranav Herur on 7/5/14.
//  Copyright (c) 2014 FunnlMail. All rights reserved.
//
#import "SentEmailThreadTableViewController.h"
...
@interface SentEmailThreadTableViewController ()

@end

@implementation SentEmailThreadTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.messageRenderingOperation = [[EmailService instance].imapSession plainTextBodyRenderingOperationWithMessage:message folder:SENT];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MCOIMAPOperation *msgOperation=[[EmailService instance].imapSession storeFlagsOperationWithFolder:SENT uids:[MCOIndexSet indexSetWithIndex:msg.uid] kind:MCOIMAPStoreFlagsRequestKindAdd flags:MCOMessageFlagSeen];
