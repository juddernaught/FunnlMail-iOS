...
//  Copyright (c) 2014 FunnelMail. All rights reserved.
//
...
- (void)viewDidLoad
{
    ...
    questions = [NSArray arrayWithObjects:@"How can Funnel Mail make mobile email easier & better?",@"What is a Funnel?",@"How are Funnels different from Gmail filters?",@"How can I create a Funnel?",@"If I create a Funnel, do emails in that Funnel move out of my Primary inbox?",@"If I delete a Funnel, does it delete my emails under that Funnel?",@"Does Funnel Mail change anything on my desktop Gmail or on other devices/ clients?", nil];
    answers = [NSArray arrayWithObjects:@"Funnel Mail (iOS) is built to help you find your most important emails faster on your mobile. With just 5-7 effective Funnels like VIP, clients, team, friends & family and news/ shopping, you can browse through your list of 100+ emails in lesser time and still stay on top!",@"Funnel (filter “from:”) is a filtered set of emails from a specific sender/ group of senders. With Funnels, you can organize your emails the way you like. You can create a Funnel for work teams or clients, and other Funnels for friends, family or even news",@"You can create Funnels easily when reading emails on your iPhones. Funnels work more like Gmail labels than folders – emails from important senders can go into more than one Funnel at the same time if you choose",@"Super easy – simply swipe (right to left) any email and Funnel Mail will automatically create a new Funnel with the sender/ s who sent you that particular email. Funnels organize all previous emails in your inbox from these senders as well as new emails received from these senders going forward",@"No – not by default. However you can choose to take out all emails in a Funnel from the primary inbox if you want to (eg. for shopping promotions or listserves)",@"No – Funnel is only a filter rule. Deleting a Funnel will not delete any of your emails. It will simply delete that label from those emails",@"No – Funnel Mail only organizes your emails on the iPhone. It does not change anything on your desktop Gmail or anywhere else. However when you mark emails read, archive or trash them, we do sync that with your Gmail server", nil];
