  ...
  if (![[NSUserDefaults standardUserDefaults] objectForKey:@"all_notificatio"]) {
    ...
    if(contextIOAPIClient.isAuthorized){
        ...
        if (![[NSUserDefaults standardUserDefaults] boolForKey:@"NOTIFS_ON_FIRST_TIME"]) {
            ...
            [contextIOAPIClient createWebhookWithCallbackURLString:@"http://funnlmail.parseapp.com/send_notification2" failureNotificationURLString:@"http://funnlmail.parseapp.com/failure" params:params success:^(NSDictionary *responseDict) {
