...
//                    cell.dateLabel.text = [message.header.date timeAgo];
                ...
                if (cell.subjectLabel.text.length == 0)
                    ...
                    if ([self willFitString:cell.subjectLabel.text InLabel:cell.subjectLabel]) {
                        ...
                        cell.threadLabel.frame = CGRectMake(13 + labelSize.width, 33 + 2.25, cell.threadLabel.frame.size.width, cell.threadLabel.frame.size.height);
                    }
                    else {
                        cell.threadLabel.frame = CGRectMake(13 + 320 - 108 + 17, 33 + 2.25, 48-5, 15);
                    }
                }
